  ...
  <div class="grid grid-cols-8 pt-1 sm:grid-cols-10  m-5">
    ...
    <div class="col-span-2 hidden sm:block">
      <ul>
        ...
        <li class="mt-5 cursor-pointer border-l-2  bg-black border-transparent px-2 py-2 text-center font-semibold transition hover:bg-black text-white"> <a href="/security">Dashboard</a> </li>
        <li class="mt-5 cursor-pointer border-l-2  border-transparent px-2 py-2 text-center text-black font-semibold transition hover:bg-black hover:text-white"><a href="/bank_account">Sales</a></li>
        <li class="mt-5 cursor-pointer border-l-2 border-transparent px-2 py-2 text-center font-semibold transition hover:bg-black hover:text-white">Transactions</li>
