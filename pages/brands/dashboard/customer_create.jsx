...
import styles from '../../../styles/new_customers.module.css';
    ...
    <div>
           ...
           <div className={styles.columnText}>
               <form className={styles.form}>
                   ...
                   <h1 className={styles.greeting}>Create Customer</h1>
                <br />
                   <div>
                   <label for="email" className="block mb-2 ml-19 text-sm font-medium text-black">First Name</label> 
                   ...
                   <div>
                   <label for="brand_bio" className="block mb-2 ml-19 text-sm font-medium text-black">Last Name</label> 
                   ...
                   <div>
                   <label for="brand_bio" className="block mb-2 ml-19 text-sm font-medium text-black">Phone Number (Optional)</label> 
                   ...
                   <div>
                   <label for="brand_bio" className="block mb-2 ml-19 text-sm font-medium text-black">Email Address (Optional)</label> 
                   ...
                   <div>
                    <h2 className="bolder ml-19 text-xl">Shipping Address</h2> <br /> <hr />
                   <label for="brand_bio" className="block mb-2 ml-19 text-sm font-medium text-black">Address</label> 
