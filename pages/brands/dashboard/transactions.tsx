...
const ECommerce = ({merch}) => {
 ...
 const totalProfit = () =>{
  ...
  <div class="grid grid-cols-8  sm:grid-cols-10">
    ...
    <h1 className="mt-5 p-2 bolder text-center" style={{fontFamily:'Poppins, Sans-serif', fontSize:20, fontWeight:"bolder"}}>Transactions</h1>
    <button  className="bg-black text-white float-right p-3 rounded">+Add New Customer</button> <br />
      <div className="mt-4 p-4 grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
        ...
        <CardDataStats title="New Transactions" total={orderResult?.length}  levelUp>
          <svg
            className="fill-primary dark:fill-white"
            width="20"
            height="22"
