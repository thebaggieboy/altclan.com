...
<br />
															<button onClick={addToCart}  className='text-xs'  style={{backgroundColor:"black",   color:"white", padding:10, borderRadius:10, display:"flex", alignItems:"right"}}><svg style={{color:"beige", fontWeight:"bold"}}  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-xs float-end">
